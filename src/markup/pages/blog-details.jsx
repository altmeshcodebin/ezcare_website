                  ...
                  <div className='blog-card blog-single'>
                    ...
                    <div className='info-bx'>
                      ...
                      <div className='ttr-post-text'>
                        <p>
                          You just need to enter the keyword and select the keyword type to generate
                          a list of 6 title ideas and suggestions. If you’re not satisfied with the
                          results, you can always hit the refresh button to generate a new list of
                          unique titles.
                        </p>
                        <blockquote className='wp-block-quote'>
                          <p>
                            ...
                            marketers excel at creating content.
                          </p>
                        </blockquote>
                        <p>
