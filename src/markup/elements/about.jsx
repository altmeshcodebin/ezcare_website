						...
						<div className="row align-items-center">
							...
							<div className="col-lg-6 mb-30">
								<div className="heading-bx">
									<h6 className="title-ext text-secondary">Who We Are</h6>
									<h2 className="title">Local Home Care Experts Here to Serve You</h2>
									<p>EZcare Nursing is the most reliable and trustworthy Nursing Agency service in the greater Toronto Area and Ontario — providing excellent home care solutions to patients who are dealing with injury or illness and other Post Surgical conditions.</p>
								</div>
								<div className="row">
